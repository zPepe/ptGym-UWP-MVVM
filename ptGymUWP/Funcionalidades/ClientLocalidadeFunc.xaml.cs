...
namespace ptGymUWP.Funcionalidades
{
    ...
    /// </summary>
    public sealed partial class ClientLocalidadeFunc : Page
    {
        ClientViewModel ClientViewModel { get; set; }
        public ClientLocalidadeFunc()
        {
            this.InitializeComponent();
            ClientViewModel = new ClientViewModel();
            ClientViewModel.Clients = Client.GetAll();

            var groups = from t in ClientViewModel.Clients
                         group t by t.Locality;
            cvs.Source = groups;
